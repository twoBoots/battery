...
- [x] Task: Extend `battery barrel add` with Metadata Flags (372934f)
...
- [x] Task: Expose `battery://barrels/{name}/docs` & Fallback `tech-stack` MCP Resources (1715c83)
  ...
  - [x] Sub-task: Refactor & verify coverage >80% (Refactor)
- [x] Task: Enrich `battery_list_barrels` Tool & `battery://topology` Resource with Metadata (9207787)
...
- [x] Task: Update Living Capability Specs & Upstream Framework Templates (3d22c9b)
