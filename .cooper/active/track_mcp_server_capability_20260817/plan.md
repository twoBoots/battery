...
- [ ] Task 1.1: Define JSON-RPC 2.0 and MCP protocol message types (`Request`, `Response`, `Notification`, `Error`, Server Capabilities) in `internal/mcp/protocol.go` with unit tests.
