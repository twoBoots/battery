# Capability Specification Delta: CLI Self-Updater

## Capability: `cli-self-update`

### Description
Provides an in-CLI update mechanism (`battery update`) that discovers latest releases, checks version status, downloads platform-compatible prebuilt binaries, and replaces the running binary.
...
+ **WHEN** running `battery update --force`
